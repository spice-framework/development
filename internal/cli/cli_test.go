...
func TestRuntimeChecksGoReleasePolicyWithoutReleaseInputs(t *testing.T) {
	...
	accepted := []struct {
		...
		},
		{
			...
			want: "go-distribution-v1\ttoolchain\tgithub.com/spice-framework/toolchain\tv0.1.0-preview.4\n",
		},
		{
			name: "Agent module",
			arguments: []string{
			...
			want: "go-module-v1\tspice-agent\tgithub.com/spice-framework/spice-agent\tv0.1.0-preview.6\n",
		},
		{
