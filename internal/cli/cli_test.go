...
func TestRuntimeChecksGoReleasePolicyWithoutReleaseInputs(t *testing.T) {
	...
	accepted := []struct {
		...
		},
		{
			...
			want: "go-distribution-v1\tspice-agent-coding\tgithub.com/spice-framework/spice-agent-coding\tv0.1.0-preview.5\n",
		},
		{
			name: "TUI module",
			arguments: []string{
	...
	tests := []struct {
		...
		{name: "stale Toolchain preview.5", arguments: []string{"--repo", "toolchain", "--module", "github.com/spice-framework/toolchain", "--version", "v0.1.0-preview.5", "--profile", "go-distribution-v1"}, wantCode: 1, wantError: "does not match catalog"},
		{name: "stale Toolchain preview.6", arguments: []string{"--repo", "toolchain", "--module", "github.com/spice-framework/toolchain", "--version", "v0.1.0-preview.6", "--profile", "go-distribution-v1"}, wantCode: 1, wantError: "does not match catalog"},
		{name: "stale Toolchain preview.7", arguments: []string{"--repo", "toolchain", "--module", "github.com/spice-framework/toolchain", "--version", "v0.1.0-preview.7", "--profile", "go-distribution-v1"}, wantCode: 1, wantError: "does not match catalog"},
		...
		{name: "stale distribution preview.4", arguments: []string{"--repo", "spice-agent-coding", "--module", "github.com/spice-framework/spice-agent-coding", "--version", "v0.1.0-preview.4", "--profile", "go-distribution-v1"}, wantCode: 1, wantError: "does not match catalog"},
